  ...
  configs: [
    %{
      ...
      checks: [
        ...
        {Credo.Check.Design.AliasUsage, if_nested_deeper_than: 3, priority: :low},
        ...
        {Credo.Check.Design.DuplicatedCode, nodes_threshold: 3, excluded_macros: [:schema, :setup, :test]},
